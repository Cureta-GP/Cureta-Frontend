                        ...
                        children: [
                          ...
                          if (profile.relationship.isNotEmpty)
                            ProfileDetailCard(
                              ...
                              label:
                                  AppLocalizations.profilesDetailsRelationship,
                              value: AppLocalizations.getLocalizedRelationship(
                          ...
                          ProfileDetailCard(
                            ...
                            value:
                                "${profile.age} ${AppLocalizations.profilesDetailsYears}",
                          ),
                          ProfileDetailCard(
                            ...
                            value: AppLocalizations.getLocalizedGender(
                              profile.gender,
                            ),
                          ),
                          ProfileDetailCard(
                            ...
                            value: profile.bloodType.isNotEmpty
                                ? profile.bloodType
                                : AppLocalizations.commonNone,
                          ),
                          /*ProfileDetailCard(
                    icon: Icons.event,
                    label: "Created At",
                    value: profile.createdAt,
                          ...
                          ProfileDetailCard(
                            ...
                            label: AppLocalizations
                                .profilesDetailsChronicConditions,
                            items: _extractDisplayItems(
                                      ...
                                      : () async {
                                          final confirmed = await showDialog<bool>(
                                            ...
                                            builder: (context) => AlertDialog(
                                              title: Text(
                                                AppLocalizations
                                                    .profilesDetailsDeleteConfirmTitle,
                                              ),
                                              content: Text(
                                                AppLocalizations
                                                    .profilesDetailsDeleteConfirmMessage,
                                              ),
                                              actions: [
                                                TextButton(
                                          ...
                                          try {
                                            ...
                                            ScaffoldMessenger.of(
                                              ...
                                              SnackBar(
                                                content: Text(
                                                  AppLocalizations.profilesDetailsDeleteFailed(
                                                    e.toString(),
                                                  ),
                                                ),
                                              ),
